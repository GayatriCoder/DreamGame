...
function preload(){
  ...
  bevarageImg = loadImage("pizza.png");
...
function draw() {
 ...
 // background(2);
  ...
  if((score>=20) && (score<30))
  {
    ...
    food.changeAnimation("education",booksImg);
    obstacle.changeAnimation("unhealthy",pizza.png);
  }

  if((score>=30) && (score<40))
  {
    player.changeAnimation("adult",man_running);
    food.changeAnimation("success",folderImg);
    obstacle.changeAnimation("failure",drinkImg);
  }
